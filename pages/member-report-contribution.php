                    ...
                    <div class="col-sm-12">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="well">
                                        ...
                                        <form class="form-horizontal" method="post" action="?<?php echo paramEncrypt('hal=member-report-contribution')?>">
                                            <fieldset>
                                                ...
                                                $tahun    = date("Y");
                                                 ?>
                                              <label class="control-label">Date Range <span class="required">*</span>
                                              </label><br>  
                                                    <div class="controls">
                                            ...
                                            <div class="form-group">
                                              <div class="col-md-5 col-md-offset-5">
                                                <a href="?<?php echo paramEncrypt('hal=member-report-contribution')?>" class="btn btn-primary">Reset</a>
...
?>
                   ...
                   <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                <th><center>Shipment Time</center> </th>
                                                <th><center>BL</center> </th>
                                                <th><center>Contribution ($USD)</center></th>
                                            </tr>
                                        </thead>
                            ...
                            $kode=$_SESSION['kode'];
                            $no=1;
                            $tree_planted=mysql_query("select s.bl,s.id_comp,s.no,h.bl,s.fee,s.wkt_shipment from t4t_shipment s join t4t_htc h on s.bl=h.bl AND s.id_comp='$kode' and s.wkt_shipment BETWEEN '$nilai_t_awal' and '$nilai_t_akhir' group by s.bl order by h.no desc");
                            ...
                            echo mysql_error();
                             ?>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" " align="right"><?php echo $data[4] ?></td>
