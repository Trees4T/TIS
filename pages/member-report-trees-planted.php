                                            ...
                                            <div class="control-group">
                                              ...
                                              <div class="controls col-sm-5">
                                                ...
                                                if (isset($_POST['member'])) {
                                                    ...
                                                    $nama0=mysql_fetch_row(mysql_query("select id,nama from t4t_partisipan where id='$id_member'"));
                                                ?>    
                                               ...
                                               <?php  
                                               $nama = mysql_query("select id,nama from t4t_partisipan order by nama");
...
<button type="submit" class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export to Excel</button>
                   ...
                   <table id="example" class="table table-striped responsive-utilities jambo_table" border="1">
                            ...
                            $no=1;
                            $tree_planted=mysql_query("SELECT s.wkt_shipment,s.bl,s.id_comp,s.no,h.bl,h.jml_phn,s.bl_tgl,h.petani,h.desa,h.ta,h.mu,s.buyer,s.no_shipment from t4t_shipment s join t4t_htc h on s.bl=h.bl AND s.id_comp='$kode' and s.wkt_shipment between '$nilai_t_awal' and '$nilai_t_akhir' order by h.no desc");
                            ...
                            echo mysql_error();
                             ?>
                                ...
                                <tr class="even pointer">
                                    ...
                                    if ($data[11]!='') {
                                        $ret=$data[11];
                                        $nama_ret=mysql_fetch_row(mysql_query("SELECT retailer_name from t4t_retailer where kode_retailer='$ret'"));
                                        if ($nama_ret[0]==true) {
                                            echo $nama_ret[0];
                                        }else{
                                            echo $ret;
