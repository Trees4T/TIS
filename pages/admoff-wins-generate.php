                ...
                <div class="x_content">
                  <br />
                    ...
                    <div class="col-sm-12">
                                ...
                                <div class="x_content">
                                    <div class="well">
                                      <form class="" action="../action/win-url-generate.php" method="post">

                                        <input type="text" name="winawal" class="form-control" value="" style="width:200px" placeholder="Wins">
                                        <input type="text" name="jmlwin" class="form-control" value="" style="width:200px" placeholder="Qty">
                                        <br>
