                    ...
                    <div class="col-sm-12">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="well">
                                        ...
                                        <form class="form-horizontal" method="post" action="?<?php echo paramEncrypt('hal=member-report-win')?>">
                                            <fieldset>
                                            ...
                                            <div class="form-group">
                                              <div class="col-md-5 col-md-offset-5">
                                                <a href="?<?php echo paramEncrypt('hal=member-report-win')?>" class="btn btn-primary">Reset</a>
                   ...
                   <table id="example" class="table table-striped responsive-utilities jambo_table">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th><center>Number of Check</center></th>
                                            </tr>
                                        </thead>
                            ...
                            $kode=$_SESSION['kode'];
                            $no=1;
                            $tree_planted=mysql_query("select s.bl,s.id_comp,count(l.win),l.bl,l.win,l.tgl from t4t_shipment s join log_wincek l on s.bl=l.bl AND s.id_comp='$kode' and l.tgl BETWEEN '$nilai_t_awal' and '$nilai_t_akhir' group by l.bl order by l.tgl desc");
                            ...
                            echo mysql_error();
                             ?>
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td class=" " align="center"><?php echo $data[4] ?></td>
                                    <td class=" " align="center"><?php echo $data[2] ?></td>
