...
<div class="page-title">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-folder-open"></i> List Desa <small></small></h2>
        ...
        ?>
            $(function fc() {
                ...
                $.each(dataid,function(i,id) {
                    ...
                    $.get("?<?php echo paramEncrypt('content=fc-content-dataanggota-keltani&nama_desa='.$nama_desa->desa.'&nama_kec='.$nama_kec->kecamatan.'&nama_kab='.$nama_kab->nama.'')?>",function(html_widget) {
