...
if (isset($btn_save_win)) {
  ...
  $update_win=mysql_fetch_row(mysql_query("update t4t_order set wins1='$wins1', wins2='$wins2' where no_order='$order' "));
  ...
  $update_acc1=mysql_fetch_row(mysql_query("update t4t_order set acc='0' where no_order='$order'"));
  ...
  $update_acc0=mysql_fetch_row(mysql_query("update t4t_order set acc='1' where no_order='$order'"));
