...
if (isset($btn_save_win)) {
  ...
  $update_win=mysql_fetch_row(mysql_query("update t4t_shipment set wins_used='$wins', wkt_shipment='$data_wkt_ship' where bl='$bl' "));
  $error_win=mysql_error();
  ...
  $update_acc1=mysql_fetch_row(mysql_query("update t4t_shipment set acc='0', wkt_shipment='$data_wkt_ship' where bl='$bl'"));
  ...
  $update_acc0=mysql_fetch_row(mysql_query("update t4t_shipment set acc='1', wkt_shipment='$data_wkt_ship' where bl='$bl'"));
